...
original_image = cv2.imread('tes.jpg')

#load the sample images and get the 128 face embeddings from them
agung_image = face_recognition.load_image_file('img/agung.jpg')
agung_face_encodings = face_recognition.face_encodings(agung_image)[0]


#save the encodings and the corresponding labels in seperate arrays in the same order
known_face_encodings = [agung_face_encoding]
known_face_names = ["Agung"]
known_face_npm = ["562020120020"]

#load the unknown image to recognize faces in it
image_to_recognize = face_recognition.load_image_file('tes.jpg')
