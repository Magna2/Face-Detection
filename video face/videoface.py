...
file_video_stream = cv2.VideoCapture('images/testing/ngetes.mp4')
...
jokowi_image = face_recognition.load_image_file('images/samples/jokowi.jpeg')
jokowi_face_encodings = face_recognition.face_encodings(jokowi_image)[0]

#save the encodings and the corresponding labels in seperate arrays in the same order
known_face_encodings = [elon_face_encodings, jokowi_face_encodings]
known_face_names = ["Elon Musk", "Joko Widodo"]
known_face_profesi = ["CEO Tesla", "Presiden Indonesia"]
